...
class DecodeStrategy(object):
    ...
    def __init__(self, pad, bos, eos, batch_size, parallel_paths,
                 ...
                 return_attention, max_length, max_length_a, max_length_b):
    ...
    def initialize(self, memory_bank, src_lengths, src_map=None, device=None,
        ...
        # self.max_length = (src_lengths * self.max_length_a + self.max_length_b).long()
    ...
    def ensure_max_length(self):
        ...
        mask = (len(self) == (self.max_length + 1)).unsqueeze(-1).expand_as(self.is_finished)
        self.is_finished.masked_fill_(mask, 1)
