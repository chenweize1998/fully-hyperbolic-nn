...
def model_opts(parser):
    ...
    group.add('--encoder_type', '-encoder_type', type=str, default='rnn',
              choices=['rnn', 'brnn', 'ggnn', 'mean', 'transformer', 'cnn', 'htransformer',
                       'ltransformer'],
...
def train_opts(parser):
    ...
    group.add('--fd_r', '-fd_r', type=float, default=2.)
    group.add('--fd_t', '-fd_t', type=float, default=1.)
